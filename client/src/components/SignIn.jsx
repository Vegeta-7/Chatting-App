    ...
    return (
        <div className="flex flex-col items-center justify-center p-4 m-4">
            <form className="bg-white rounded-lg shadow-lg p-8" onSubmit={handleSubmit}>
                ...
                <p className="text-sm text-center mb-6">By signing in you agree to our <a href="/terms" className="text-green-500">Term and privacy policy</a></p>
                ...
                <button className="w-full bg-blue-500 py-3 rounded text-white" type='submit'>Login</button>
